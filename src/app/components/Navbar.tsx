...
const Navbar = () => {
  ...
  return (
    <div className="bg-transparent w-full h-[90px] flex justify-between items-center px-4 sm:px-6 md:px-10 lg:px-12 2xl:w-[1320px] 2xl:px-0">
      {/* Logo */}
      <Link href="/">
        <div className="flex-shrink-0 2xl:w-[109px] 2xl:h-[42px]">
          <Image
            src="/Foodtuck.png"
            alt="Foodtuck"
            width={109}
            ...
            quality={100}
            placeholder="empty"
            className=" 2xl:w-full 2xl:h-[40px]"
          />
        </div>
      </Link>
      {/* Navigation Links */}
      <div
        className={`hidden md:flex text-white gap-4 lg:gap-6 text-sm lg:text-base 2xl:gap-10 2xl:font-bold 2xl:text-[16px]`}
      >
        <Link href="/">
