...
const page = () => {
  return (
    <div>
      ...
      <div className="w-[424px] h-[564px] rounded-lg shadow-lg flex flex-col items-center p-6 mt-[100px] ml-[748px]">
        {/* Heading */}
        ...
        <div className=" items-center mb-4 w-[360px] flex justify-end">
          <label htmlFor="remember" className="text-sm text-gray-600 flex justify-end">
          Forget password?
          </label>
        </div>
